...
void __attribute__((picinterrupt(("")))) interrupt_PIC()
{
...
void main(void)
{
    ...
    while(1)
    {
        ...
        if(PORTBbits.RB3 == 0 && MOVE_Old == 0)
            MOVE_Old = 1;



        if(PORTBbits.RB4 == 1 && SEL_Old == 1)
        {
